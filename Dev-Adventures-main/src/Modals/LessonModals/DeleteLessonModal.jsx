...
export default function DeleteLessonModal({isOpen, onClose, courseId, lessonId, lessonTitle, onDelete}){
...
const deleteLesson = async () => {
    ...
    try{
        const response = await axios.delete(`${BASE_URL}/api/Lesson/${courseId}/${lessonId}`, {
