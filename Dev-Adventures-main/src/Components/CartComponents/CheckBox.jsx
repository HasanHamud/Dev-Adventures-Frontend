export default function CheckBox({price}){
    ...
    return(<div className="flex flex-col bg-gray-800 text-white w-64 h-48 rounded-md shadow-md">
<div className="p-4">
...
<div className="text-white px-4 mb-5 text-center my-2">
    <button className="bg-blue-500 rounded text-sm w-full p-3"> Proceed to Check Out</button>
</div>
