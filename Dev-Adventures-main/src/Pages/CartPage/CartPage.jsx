...
const CartPage = () => {
  ...
  const fetchTotalPrice = async () => {
    ...
    try {
      ...
      console.error("Error fetching total price:", error.response || error);
      setError(
        error.response?.data || "Failed to fetch cart items. Please try again."
      );
      setTotalprice(0);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-900 pt-16 overflow-auto">
      {error && (
