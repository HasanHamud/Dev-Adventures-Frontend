...
<div className="flex relative top-0 text-white flex-col mt-6">
    <p className="text-5xl mx-auto font-bold p-5 rounded-md mt-8"> About Us </p>
...
<div>
    ...
    <p className="text-white bg-slate-800 border-slate-800 border"> Malek Rizk </p>
    <p className="text-white bg-slate-800 border-slate-800 border rounded-b-md"> Full-Stack Developer </p>

</div>

<div>
<img src={Retard2} className="w-56 h-56 rounded-t-lg"></img>
    <p className="text-white bg-slate-800 border-slate-800 border"> Hasan Hammoud </p>
    <p className="text-white bg-slate-800 border-slate-800 border rounded-b-md"> Full-Stack Developer </p>
...
<FactCard title={"Where it started"} content={"Dev Adventures started as a university passion project by Malek Rizk and Hassan Hammoud in the aim to improve their skills at web development"}/>
<FactCard title={"What is our Goal?"} content={"We hope to help every student struggling in their journey of learning, we believe everyone deserves a chance to thrive in the world of programming"}/>
<FactCard title={"What to expect"} content={"Our website contains accessible courses from all different kinds of fields, albeit professional or beginner level, you will find something that suits you "}/>
